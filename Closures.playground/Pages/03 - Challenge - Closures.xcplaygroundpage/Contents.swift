//: [Episode 02: Closures](@previous)
//: ## Episode 03: Challenge - Closures
...
let himanshuFullName = calculateFullName(firstName: "Himanshu", lastName: "Rajput")
let shivanshuFullName = calculateFullName("Shivanshu", "Rajput")
...
//: [Episode 04: Closure Syntax](@next)
